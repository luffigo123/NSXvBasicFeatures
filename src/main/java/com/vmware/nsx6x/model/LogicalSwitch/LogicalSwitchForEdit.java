...
@XmlRootElement(name = "virtualWire")
public class LogicalSwitchForEdit implements LogicalSwitch{
	private String name;
	 ...
	 */
	public LogicalSwitchForEdit(String name, String description, String controlPlaneMode, String guestVlanAllowed,
			String tenantId) {
		super();
		this.name = name;
		this.description = description;
